...
(global as any).indexedDB = IDBFactory;

// import * as FDBFactory from 'fake-indexeddb';
// import {indexedDB as fakeIndexedDB} from 'fake-indexeddb';
// (global as any).indexedDB = fakeIndexedDB;

import { MockBroadcastChannel } from './mocks/MockBroadcastChannel';
...
describe('indexedDB Storage Strategy', () => {
	const hwc = new HybridWebCache('HybridWebCacheTest', { storage: StorageType.IndexedDB, removeExpired: false, ttl: 10 * 60 * 1000 });
